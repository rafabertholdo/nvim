...
-- window management
vim.keymap.set("n", "<leader>w-", "<C-w>v", { desc = "Split window vertically" }) -- split window vertically
vim.keymap.set("n", "<leader>w|", "<C-w>s", { desc = "Split window horizontally" }) -- split window horizontally
