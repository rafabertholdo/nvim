...
-- Debugger (Xcode-style keybindings)
...
vim.keymap.set("n", "<F10>", "<cmd>DapTerminate<CR>", { desc = "Terminate debugging" })

-- Alternative keybindings (keep F5 and leader for flexibility)
vim.keymap.set("n", "<F5>", "<cmd>DapContinue<CR>", { desc = "Start/Continue debugging" })
